...
<div class="px-4 py-1 my-3 text-center">
    ...
    <h1 class="container display-5 fw-bold" id="typing-effect">Default Controller</h1><sup></sup>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">Generate plain controller without already created functions</p>
...
<div class="col-lg-8 mx-auto p-4 py-md-5 mt-0">
   <center>
   <div class="mb-4 p-3 bg-dark color-light d-flex justify-content-between text-light"><div style="font-weight:900;" class="fs-1">Create New Controller</div> <div style="font-weight:900;font-size:2px;"><a class="btn btn-warning">See Existing Controller ></a></div></div><br>

   <form id="defaultController">
      {csrf_token}
     <div class="mb-3">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control form-control-lg" id="c_name" name="controller_name" placeholder="e.g User" required>
    </div>
     </div>
     <div class="col-auto">
   ...
   $(document).ready(function(){
      ...
      $('#defaultController').on('submit', function(e){
          e.preventDefault();

          $.ajax({
            type: "POST",
            url: "../generate/controller",
            data: $('#defaultController').serialize(),
